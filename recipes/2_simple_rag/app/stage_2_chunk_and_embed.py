...
# Function to process a CSV and split text into manageable chunks
def process_csv_chunking_stage(input_file, output_file):
    """Process CSV and split text into chunks"""
    ...
    text_splitter = RecursiveCharacterTextSplitter.from_language(
        ...
        chunk_size=1024,            # Maximum size of a text chunk
...
if __name__ == "__main__":
    ...
    # Run the text chunking stage on the input data
    process_csv_chunking_stage(input_path, chunk_output)
    
    # Run the embedding stage on the chunked text data
    process_csv_embedding_stage(chunk_output, embedding_output)  # 2 min and 14 seconds for embedding